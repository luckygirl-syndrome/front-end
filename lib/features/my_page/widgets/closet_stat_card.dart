  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.black.withValues(alpha: 0.15), // 아주 은은한 그림자
            blurRadius: 12,
      ...
      child: Column(
        ...
        children: [
          ...
          Text('$count벌',
              style: AppTextStyles.ptdExtraBold(32)
                  .copyWith(height: 1.0)), // 글자 크기 상향
          const SizedBox(height: 8),
          Text(price,
              style: AppTextStyles.ptdRegular(12).copyWith(height: 1.0)),
        ],
      ),
    );
  }
